<?php
  ...
  if($user!="" && $pass!="")
  {
    $conn = @mysql_connect ("your db host url", "db username", "db password") or die ("Sorry - unable to connect to MySQL database.");
    $rs = @mysql_select_db ("db name", $conn) or die ("error");
